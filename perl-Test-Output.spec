%{?scl:%scl_package perl-Test-Output}
%{!?scl:%global pkg_name %{name}}

Name:           %{?scl_prefix}perl-Test-Output
Version:        1.02
Release:        2.sc1%{?dist}
...
BuildArch:      noarch
BuildRequires:  %{?scl_prefix}perl(Capture::Tiny) >= 0.17
BuildRequires:  %{?scl_prefix}perl(Carp)
BuildRequires:  %{?scl_prefix}perl(ExtUtils::MakeMaker)
BuildRequires:  %{?scl_prefix}perl(File::Temp) >= 0.17
...
BuildRequires:  %{?scl_prefix}perl(Test::Tester) >= 0.103
...
%changelog
* Thu Nov 21 2013 Jitka Plesnikova <jplesnik@redhat.com> - 1.02-2
- Rebuilt for SCL
